...
const Contact = () => {
  ...
  return (
    <>
      <Head>
        <title>Contact - Sabbir Ahamed Redoy - Get In Touch | Web Developer from DIU</title>
        <meta name="description" content="Contact Sabbir Ahamed Redoy (Md. Sabbir Ahamed) from Daffodil International University for web development projects, collaborations, or inquiries. Get in touch with Sabbir Ahamed Redoy for professional web development services." />
        <meta name="keywords" content="Contact Sabbir Ahamed Redoy, Sabbir Ahamed Redoy contact, Sabbir Ahamed contact, Sabbir Ahamed DIU, Sabbir Redoy, Sabbir DIU, hire Sabbir Ahamed Redoy, hire web developer, contact web developer, DIU web developer contact, professional web developer" />
        <meta property="og:title" content="Contact- Sabbir Ahamed Redoy" />
        <meta property="og:description" content="Get in touch with Sabbir Ahamed Redoy for web development projects and collaborations." />
      ...
      <div className="flex flex-col w-full max-w-[700px]">
        ...
        >
          Have a question, collaboration idea, or just want to say hello? Fill out the form and I&rsquo;ll get back within 24-48 hours. Or email me directly at <a href="mailto:contact@sabbirahamed.site" className="text-accent underline">contact@sabbirahamed.site</a>.
        </motion.p>
        {/* form */}
        <motion.form
          ref={form}
